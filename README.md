...
The implementation of AdaOrder corresponds to the following paper: .

Its source code can be found in https://github.com/Shamir-Lab/AdaOrder/.

To cite this the AdaOrder paper use the following form:
...
These 2 files are generated by the AdaOrder application.
